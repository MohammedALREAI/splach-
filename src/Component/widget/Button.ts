...
max-width:${props => props.maxWidth ? (typeof (props.maxWidth) === 'string' ? props.maxWidth : props.maxWidth + 'px') : 'none'};
min-width:${props => props.minWidth ? (typeof (props.minWidth) === 'string' ? props.minWidth : props.minWidth + 'px') : '0px'};
